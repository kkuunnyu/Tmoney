            ...
            if (res.data.success == true) {
                ...
                if (res.data.data.totalElements === 0) {
                    ...
                    <tr>
                            ...
                            <td bgcolor="#f0f0f0" width="130px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">터미널코드</td>
                            <td bgcolor="#f0f0f0" width="150px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">터미널이름</td>
                            <td bgcolor="#f0f0f0" width="150px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">터미널단축명</td>
                            <td bgcolor="#f0f0f0" width="140px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">위·경도</td>
                            <td bgcolor="#f0f0f0" width="400px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">주소</td>
                            <td bgcolor="#f0f0f0" width="120px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">우편번호</td>
                            <td bgcolor="#f0f0f0" width="220px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">시외버스시스템구분코드</td>
                        </tr>
                        <tr>
...
document.querySelector("#resetBtn").addEventListener("click", function () {
    ...
    window.location.href = "terminal?page=0&size=10&sort=0"
})
