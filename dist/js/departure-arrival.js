const deptArvlList = document.querySelector('#deptArvlList');
...
function initTable(noContent) {
    ...
    deptArvlList.innerHTML = `
    <tr>
        <td bgcolor="#f0f0f0" class="table-no" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">No</td>
        <td bgcolor="#f0f0f0" class="departure-terminal" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">출발 터미널</td>
        <td bgcolor="#f0f0f0" class="arrive-terminal" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">도착 터미널</td>
    </tr>
    `
    if (noContent) {
        deptArvlList.innerHTML += `
...
document.querySelector("#resetBtn").addEventListener("click", function () {
    ...
    // loadPage(pageOption);
    window.location.href = "departure-arrival?page=0&size=10&sort=1"
})
