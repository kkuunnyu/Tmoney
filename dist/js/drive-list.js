        ...
        .then((res) => {
            if (res.data.success == true) {
                ...
                if (totalElements === 0) {
                    ...
                    cacmList.innerHTML = `
                        <tr>
                            <td bgcolor="#f0f0f0" class="table-no">No</td>
                            <td bgcolor="#f0f0f0">운수사 코드</td>
                            <td bgcolor="#f0f0f0">운수사 이름</td>
                            <td bgcolor="#f0f0f0">운수사단축명</td>
                            <td bgcolor="#f0f0f0">주소</td>
                            <td bgcolor="#f0f0f0">전화번호</td>
                        </tr>
                        <tr>
                    ...
                    cacmList.innerHTML = `
                        <tr>
                            ...
                            <td bgcolor="#f0f0f0" width="120px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">운수사 코드</td>
                            <td bgcolor="#f0f0f0" width="160px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">운수사 이름</td>
                            <td bgcolor="#f0f0f0" width="140px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">SHCT</td>
                            <td bgcolor="#f0f0f0" width="400px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">주소</td>
                            <td bgcolor="#f0f0f0" width="150px" style="border-top: 1px solid #000; border-bottom: 1px solid #000; font-weight: 600;">전화번호</td>
                        </tr>`;
...
document.querySelector("#resetBtn").addEventListener("click", function () {
    ...
    window.location.href = "drive-list?page=0&size=10&sort=0"
});
